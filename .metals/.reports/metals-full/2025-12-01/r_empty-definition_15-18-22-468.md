error id: file:///D:/3rd%20yr%20backend/Microserevices_Lerning_Project/microservices_pos/order/src/main/java/com/example/order/service/OrderServiceImpl.java:_empty_/InventoryDTO#
...
empty definition using pc, found symbol in pc: _empty_/InventoryDTO#
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse saveOrder(OrderDTO orderDTO) {
        ...
        Integer productId = Inventor@@yDTO.getProd
