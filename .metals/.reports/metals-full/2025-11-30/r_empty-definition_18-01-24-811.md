error id: file:///D:/3rd%20yr%20backend/Microserevices_Lerning_Project/microservices_pos/order/src/main/java/com/example/order/service/OrderService.java:_empty_/SuccessOrderResponse#
...
empty definition using pc, found symbol in pc: _empty_/SuccessOrderResponse#
    ...
    public OrderResponse saveOrder(OrderDTO orderDTO) {
        ...
        try {
            ...
            if (inventoryResponse != null && inventoryResponse.getQuantity() > 0) {
                ...
                return new SuccessOr@@derResponse(orderDTO);
            } else {
